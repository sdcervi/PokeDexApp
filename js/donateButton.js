var kofiwidgetCustom = kofiwidgetCustom || (function () {
	...
	return {
		init: function (pText, pColor, pId) {
			...
			html += '<div class=btn-container><a title="Become a member" class="kofi-button" style="background-color:[color];" href="https://ko-fi.com/pokedexapp/tiers" target="_blank"> <span class="kofitext"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg"/>[text]</span></a></div>';
		},
		getHTML: function () {
