var kofiwidgetCustom = kofiwidgetCustom || (function () {
	var style = "";
	var html = "";
	var color = "";
	var text = "";
	...
	return {
		init: function (pText, pColor, pId) {
			...
			html += '<div class=btn-container><a title="Become a member" class="kofi-button" style="background-color:[color];" href="https://ko-fi.com/summary/b141f6ff-20af-4b40-bc4e-c45ab82bbfc0" target="_blank"> <span class="kofitext"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg"/>[text]</span></a></div>';
		},
		getHTML: function () {
